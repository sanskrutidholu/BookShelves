package com.example.bookcave.common;
...
public class CreateAccountCustomer extends AppCompatActivity {
    ...
    private TextView login, change_account;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        change_account = findViewById(R.id.tv_main);
        ...
        change_account.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(CreateAccountCustomer.this, MainScreenActivity.class);
                startActivity(i);
                finish();
            }
        });
                ...
                fAuth.createUserWithEmailAndPassword(semail,spassword).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful()){
                            ...
                            Log.e("data", String.valueOf(user));
                            ...
                            db.collection("Users").document(userid).set(user).addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if(task.isSuccessful()) {
                                        ...
                                        Intent i = new Intent(CreateAccountCustomer.this, HomeCustomer.class);
                                        startActivity(i);
                                    } else{
                                        createaccButton.setText("Create Account");
